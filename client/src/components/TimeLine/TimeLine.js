...
const TimeLine = (props) => {
  ...
  const handleStepTime = (e, time,i) => {
    ...
    let newTime = moment.duration(props.currentMedia.duration / 100 * (leftPad * 100 / widthBox), 'seconds')
  ...
  const resizeRight = e => {
    ...
    props.setCurrentMedia({...props.currentMedia,
    ...
    <div className="TimeLine">
      <div className="TimeLine__inner" ref={timeLineBox}>
        ...
        <div className="comment__inner" style={{left: window.innerWidth > 575 && shift - 3.2 + "%"}}>
                      ...
                      />
          <div className="square" style={{left: window.innerWidth < 575
              && (shift < 95 ? shift  + "%" : '95%')}}/>
